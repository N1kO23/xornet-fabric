...
public class Xornet implements ModInitializer {
	...
	public static final BlockItem SERVER_2U_BLOCKITEM = new BlockItem(SERVER_2U, new FabricItemSettings().group(ItemGroup.BUILDING_BLOCKS));
	public static final BlockItem SERVER_1U_BLOCKITEM = new BlockItem(SERVER_1U, new FabricItemSettings().group(ItemGroup.BUILDING_BLOCKS));
	...
	public static final ItemGroup XORNET_ITEM_GROUP = FabricItemGroupBuilder.create(
			new Identifier(MOD_ID, "general"))
				...
				.appendItems(stacks -> {
					...
					stacks.add(new ItemStack(SERVER_2U_BLOCKITEM));
					stacks.add(new ItemStack(SERVER_1U_BLOCKITEM));
				})
				.build();
	...
	public void onInitialize() {
		...
		Registry.register(Registry.ITEM, new Identifier(MOD_ID, "server_2u"),  SERVER_2U_BLOCKITEM);
		Registry.register(Registry.ITEM, new Identifier(MOD_ID, "server_1u"),  SERVER_1U_BLOCKITEM);
		...
		Registry.register(Registry.BLOCK, new Identifier(MOD_ID, "server_2u"),  SERVER_2U);
		Registry.register(Registry.BLOCK, new Identifier(MOD_ID, "server_1u"),  SERVER_1U);
